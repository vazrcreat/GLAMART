...
if (isset($_GET['id'])) {
    ...
    if ($action == 'ajax') {
        ...
        $aColumns = ['firstname', 'lastname']; //Columnas de busqueda
        $sTable = 'users';
        $sWhere = '';
        if ($_GET['q'] != '') {
            $sWhere = 'WHERE (';
			...
			<div class="table-responsive">
			  <table class="table">
				<tr  class="info">
					...
					<th style="background-color:#000000;">Nombres</th>
					<th style="background-color:#000000;">Usuario</th>
					<th style="background-color:#000000;">Email</th>
					<th style="background-color:#000000;">Agregado</th>
					<th style="background-color:#000000;"><span class="pull-right">Acciones</span></th>
